...
public class MemberDto {
	...
	// 기본 생성자
	// 파라미터 전체 초기화하는 생성자
	public MemberDto() {			//alt + shift + s  -> generate constructors from superclass
	}


	public MemberDto(int m_no, String m_name, int m_age, String m_gender, String m_location, String m_job, String m_tel,     
			String m_email) {        //alt + shift + s  ->  generate constructors using fields
		super();
		this.m_no = m_no;
		this.m_name = m_name;
		this.m_age = m_age;
	...
	// getter & setter      //alt + shift + s  -> generate getters and setters
	public int getM_no() {
		return m_no;
	}
