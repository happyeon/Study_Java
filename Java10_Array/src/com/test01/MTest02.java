...
public class MTest02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(s));        // 1차원 배열만 출력 가능
		System.out.println(Arrays.deepToString(s));    // 다차원 배열의 값들도 모두 출력
	}
	
	public static void modi(String[][] arr) {
		// nice -> good / 어려워 -> 쉬워 로 바꾸고
		// 전체 출력하자.
		arr[0][2] = "good";
		arr[1][1] = "쉬워";
