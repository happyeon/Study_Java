...
public class MTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. 같은 패키지에 Score 클래스를 만들자.
		 * 
		 * 2. Score class에서
		 * 	  kor, eng, math 값을 받아서, 세 값의 평균을 리턴하는
		 * 	  getAvg 메소드를 만들자.
		 *    같은 패키지에서만 접근 가능하고, static 영역에 저장된다.
		 * 
		 * 3. Score class에서,
		 ...
		 *    
		 * 4. MTest class에서 Score 클래스의 두 메소드를 호출해서 리턴받은 값을 출력하자.
		 * 
		 * 출력 예) 김연아 님의 평균은 98.99점이고, 등급은 "A" 입니다.
		 */
		...
		System.out.printf("%s 님의 평균은 %.2f점 이고, 등급은 \"%s\" 입니다.", name, avg, grade);
